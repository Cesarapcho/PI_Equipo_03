...
<p align="center">
  ...
  <br><br>
  <img src="https://github.com/Cesarapcho/PI_Equipo_03/blob/main/Proyecto_Integrador/Entregables/imagenes/Esquema_funciones_v4.png" alt="Esquemático de funciones del sistema" width="1100">
</p>
<p align="center">
  <strong>Material complementario</strong>
  <br><br>
  <a href="https://app.diagrams.net/#G1Bdu2SNgz67INHfEh7ccAgwM3UI_dBBii#%7B%22pageId%22%3A%22snAYjtPcCaeU7Q8ji4L4%22%7D">
    🔗 Consultar Esquema de funcinoes
  </a>
</p>
...
<p align="center">
  ...
  <br><br>
  <img src="https://github.com/Cesarapcho/PI_Equipo_03/blob/main/Proyecto_Integrador/Entregables/imagenes/Matriz_Morfologica_v3.jpg" alt="Matriz morfológica y alternativas tecnológicas" width="1000">
</p>
...
<p align="center">
  ...
  <br><br>
  <img src="./imagenes/soluciones_v2.png" alt="Soluciones preliminares del sistema" width="1100">
</p>

Las soluciones preliminares permiten visualizar las diferentes configuraciones propuestas antes de realizar la evaluación mediante los criterios de selección. Posteriormente, estas alternativas fueron comparadas para determinar la configuración más conveniente para el desarrollo del sistema.
...
### 2.3.5. Evaluación mediante Matriz de Pugh

Como etapa previa a la evaluación ponderada, se empleó una **Matriz de Pugh** para realizar una comparación relativa entre los conceptos de solución.

Para esta comparación se tomó el **Concepto A como referencia**, mientras que los conceptos B y C fueron evaluados respecto a cada uno de los criterios establecidos.

La valoración se realizó mediante la siguiente escala:

- **+1:** el concepto evaluado presenta un desempeño superior al concepto de referencia.
- **0:** el desempeño es equivalente al concepto de referencia.
- **−1:** el desempeño es inferior al concepto de referencia.

<p align="center">
  <strong>Figura 6. Matriz de Pugh para la comparación de los conceptos</strong>
  <br><br>
  <img src="./imagenes/pugh_v2.png" alt="Matriz de Pugh para la comparación de conceptos" width="1000">
</p>

Los resultados de la Matriz de Pugh muestran el desempeño relativo de los conceptos B y C respecto al Concepto A. La suma de los valores obtenidos permite identificar las diferencias de desempeño entre las alternativas consideradas y sirve como apoyo para la posterior evaluación ponderada.

---

### 2.3.6. Valoración de los conceptos
...
<p align="center">
  <strong>Figura 7. Puntaje de los conceptos según los criterios establecidos</strong>
  <br><br>
...
La selección final se realizó mediante la ponderación de cada criterio según su importancia dentro del sistema.
...
<p align="center">
  <strong>Figura 8. Evaluación ponderada y resultado final</strong>
  <br><br>
...
### 2.3.8. Resultado del proceso de selección
...
**Funciones → Alternativas tecnológicas → Soluciones preliminares → Conceptos → Criterios de evaluación → Matriz de Pugh → Puntajes → Ponderación → Concepto A**
